...
(function() {
  ...
  // MSSQL keywords have been altered (RD, 2017-12-25)
  // Additional keywords added (RD, 2018-02-03)
  CodeMirror.defineMIME("text/x-mssql", {
    name: "sql",
    client: set("charset clear connect edit ego exit go help nopager notee nowarning pager print prompt quit rehash source status system tee"),
    keywords: set("add external procedure fetch public alter file raiserror fillfactor read \
    ...
    function return returns break goto revert browse grant revoke bulk group by having rollback \
    ...
    builtin: set("nullif try_convert tsequal update current_user current_timestamp current_time convert system_user \
    session_user contains collate coalesce len isnull power scope_identity getdate lower is_srvrolemember quotename "),
      // "bigint numeric bit smallint decimal smallmoney int tinyint money float real char varchar text nchar nvarchar ntext binary varbinary image cursor timestamp hierarchyid uniqueidentifier sql_variant xml table "),
    atoms: set("some all pivot exists unpivot or outer cross left like not null \
